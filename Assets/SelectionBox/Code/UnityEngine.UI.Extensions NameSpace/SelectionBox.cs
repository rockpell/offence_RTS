...
namespace UnityEngine.UI.Extensions {
	...
	public class SelectionBox : MonoBehaviour
	{
		...
		private static SelectionBox _instance;
		public static SelectionBox instance{
			get{
				if(!_instance){
					_instance = GameObject.FindObjectOfType(typeof(SelectionBox)) as SelectionBox;
					if(!_instance){
						GameObject container = new GameObject();
						container.name = "SelectionBoxContainer";
						_instance = container.AddComponent(typeof(SelectionBox)) as SelectionBox;
					}
				}
				return _instance;
			}
	 ...
	 */
		...
		public IBoxSelectable[] getSelectables(){
